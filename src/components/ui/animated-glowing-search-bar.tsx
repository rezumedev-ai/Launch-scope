  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-full overflow-hidden">
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[min(464px,90vw)] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[min(462px,88vw)] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[min(457px,86vw)] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[min(453px,85vw)] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative group">
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg bg-white/90 hidden sm:block
          ...
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-gray-100 via-white to-gray-50 border border-gray-200 shadow-sm hidden sm:flex">
          ...
          <div id="search-icon" className="absolute left-3 sm:left-5 top-[15px]">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <input 
              ...
              disabled={disabled}
              className="bg-white border-none w-full max-w-[min(450px,85vw)] h-[56px] rounded-lg text-gray-800 pl-10 pr-3 sm:pl-[59px] sm:pr-12 text-base sm:text-lg focus:outline-none placeholder-gray-500 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed" 
            />
          </form>
        </div>
      </div>
