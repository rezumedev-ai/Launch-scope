...
const SearchComponent = ({ 
  ...
  return (
    <div className="relative flex items-center justify-center w-full max-w-full overflow-hidden px-4">
      <div className="absolute z-[-1] w-full h-min-screen"></div>
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[min(400px,85vw)] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[min(398px,83vw)] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[min(395px,81vw)] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[min(390px,80vw)] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative group">
          ...
          <div className="absolute h-[42px] w-[40px] overflow-hidden top-[7px] right-[7px] rounded-lg bg-white/90 hidden md:block
          ...
          <div id="filter-icon" className="absolute top-2 right-2 flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-gray-100 via-white to-gray-50 border border-gray-200 shadow-sm hidden md:flex">
          ...
          <div id="search-icon" className="absolute left-3 top-[15px]">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <input 
              ...
              disabled={disabled}
              className="bg-white border-none w-full max-w-[min(390px,80vw)] h-[56px] rounded-lg text-gray-800 pl-10 pr-3 text-base focus:outline-none placeholder-gray-500 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed" 
            />
          </form>
        </div>
      </div>
