        ...
        <div className="max-w-7xl mx-auto text-center text-white relative z-10">
          ...
          <div className="mb-12 relative">
            <div className="max-w-6xl mx-auto">
              <div className="relative bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 md:p-8 overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 grid md:grid-cols-2 gap-6 md:gap-8 items-stretch">
                  {/* LEFT: AI-Powered Execution */}
                  <div className="relative">
                    <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/20 p-6 h-full flex flex-col hover:bg-white/10 transition-all duration-500">
                      <div className="mb-5 relative">
                        <div className="absolute inset-0 bg-blue-300/20 blur-2xl rounded-full"></div>
                        <div className="relative inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-xl shadow-lg mx-auto">
                          <Zap className="w-7 h-7 text-white" />
                        </div>
                      </div>

                      <h3 className="text-2xl font-bold text-white mb-2">EASY</h3>
                      <p className="text-blue-100 mb-6">AI-Powered Execution</p>

                      {/* AI Tools Grid */}
                      <div className="grid grid-cols-3 gap-3 mb-6 flex-grow items-center">
                        <div className="group relative">
                          ...
                          <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                            <div className="flex items-center justify-center mb-2 h-8">
                              <CursorLogo className="w-8 h-8 text-white" />
                            </div>
                            <div className="text-white text-xs font-medium">Cursor</div>
                          </div>
                        </div>
                        ...
                        <div className="group relative">
                          ...
                          <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                            <div className="flex items-center justify-center mb-2 h-8">
                              <ClaudeLogo className="w-8 h-8 text-pink-300" />
                            </div>
                            <div className="text-white text-xs font-medium">Claude</div>
                          </div>
                        </div>
                        ...
                        <div className="group relative">
                          ...
                          <div className="relative bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-3 hover:bg-white/15 transition-all duration-300 transform hover:scale-105">
                            <div className="flex items-center justify-center mb-2 h-8">
                              <OpenAILogo className="w-8 h-8 text-blue-300" />
                            </div>
                            <div className="text-white text-xs font-medium">OpenAI</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-center gap-3 mt-auto pt-4 border-t border-white/10">
                        <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2">
                          <div className="text-blue-200 font-mono text-xs">&lt;code/&gt;</div>
                        </div>
                        <div className="flex flex-col gap-1">
                          <div className="w-6 h-0.5 bg-gradient-to-r from-white/60 to-transparent animate-pulse"></div>
                          <div className="w-6 h-0.5 bg-gradient-to-r from-white/60 to-transparent animate-pulse delay-100"></div>
                          <div className="w-6 h-0.5 bg-gradient-to-r from-white/60 to-transparent animate-pulse delay-200"></div>
                        </div>
                        <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2">
                          <div className="text-blue-200 text-xs">✨ App</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="hidden md:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                    <div className="relative">
                      <div className="w-0.5 h-48 bg-gradient-to-b from-transparent via-white/40 to-transparent"></div>
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full p-3 shadow-lg shadow-pink-500/50 border-2 border-indigo-500">
                  ...
                  <div className="relative">
                    <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/20 p-6 h-full flex flex-col hover:bg-white/10 transition-all duration-500">
                      <div className="mb-5 relative">
                        ...
                        <div className="relative inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-pink-400 to-pink-500 rounded-xl shadow-lg mx-auto">
                      ...
                      <p className="text-blue-100 mb-6">Strategic Direction</p>
                      ...
                      <div className="space-y-3 flex-grow">
                        {['What problem?', 'Which market?', 'Which features?'].map((question, idx) => (
                          <div key={idx} className="group relative">
                            ...
                            <div className="relative bg-white/5 border border-white/20 rounded-lg p-4 hover:bg-white/10 transition-all duration-300">
                              <div className="flex items-center justify-between">
                                <span className="text-white font-medium text-sm">{question}</span>
                                <svg className={`w-5 h-5 text-pink-300 animate-pulse delay-${idx * 100}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center justify-center gap-2 mt-6 pt-4 border-t border-white/10">
                        ...
                        <span className="text-blue-100 text-xs font-medium">Requires Human Judgment</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="group relative">
                ...
                <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-500 transform hover:-translate-y-2">
