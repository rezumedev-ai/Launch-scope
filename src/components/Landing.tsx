      ...
      <section className="px-6 py-20 md:py-32 bg-gradient-to-br from-indigo-500 via-indigo-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center text-white relative z-10">
                    ...
                    <div className="mt-auto pt-6 border-t border-white/10">
                      <div className="flex items-center justify-center gap-4">
                        <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-3">
                          <div className="text-blue-200 font-mono text-sm font-semibold">&lt;code/&gt;</div>
                        </div>
                        <div className="flex flex-col gap-1.5">
                          <div className="w-8 h-0.5 bg-gradient-to-r from-blue-300 to-transparent animate-pulse"></div>
                          <div className="w-8 h-0.5 bg-gradient-to-r from-blue-300 to-transparent animate-pulse delay-100"></div>
                          <div className="w-8 h-0.5 bg-gradient-to-r from-blue-300 to-transparent animate-pulse delay-200"></div>
                        </div>
                        <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-3">
                          <div className="text-blue-200 text-sm font-semibold">✨ Ship</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              { icon: '💻', title: 'Code is Cheap', desc: 'AI tools ship features in days', color: 'rgba(59, 130, 246, 0.15)' },
              { icon: '🎯', title: 'Clarity is Scarce', desc: 'Knowing what to build is rare', color: 'rgba(236, 72, 153, 0.15)' },
              { icon: '🚀', title: 'Strategy Wins', desc: 'Direction beats execution speed', color: 'rgba(59, 130, 246, 0.15)' }
            ].map((item, idx) => (
