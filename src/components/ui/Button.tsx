...
export function Button({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-indigo-500 to-blue-500 text-white hover:from-indigo-600 hover:to-blue-600 focus:ring-indigo-500 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5',
